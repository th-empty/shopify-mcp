    ...
    execute: async (args) => {
      ...
      `;
            ...
            if (args.value.percentage) {
                ...
                throw new Error("Either value.percentage or value.amount must be provided");
            }
            let minRequirementInput = undefined;
            if (args.minimumRequirement) {
                if (args.minimumRequirement.quantity) {
                    minRequirementInput = {
                        quantity: {
                            greaterThanOrEqualToQuantity: args.minimumRequirement.quantity.toString(),
                        },
                    };
                }
                    ...
                    minRequirementInput = {
                        subtotal: {
                            greaterThanOrEqualToSubtotal: args.minimumRequirement.subtotal.toString(),
                        },
                    };
                }
            }
            const input = {
                ...
                endsAt: args.endsAt,
                code: args.code,
                customerSelection: args.customerSelection === "all" ? { all: true } : undefined,
                customerGets: {
                    value: valueInput,
