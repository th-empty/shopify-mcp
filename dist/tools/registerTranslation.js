...
const RegisterTranslationInputSchema = z.object({
    resourceId: z
        .string()
        .describe("The ID of the translatable resource (e.g. gid://shopify/Product/...)"),
    translations: z
        .array(z.object({
        key: z
            .string()
            .describe("The field name to translate (e.g. 'title', 'body_html') - find this via translation-get-resource"),
        ...
        translatableContentDigest: z
            .string()
            .describe("The digest hash of the original content - MUST match what is returned by translation-get-resource"),
    }))
        .min(1)
...
const registerTranslation = {
    ...
    description: "Register or update translations for a Shopify resource (like Products, Collections). Note: You MUST fetch the translatableContentDigest first using translation-get-resource!",
      ...
      `;
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: JSON.stringify({ success: true, translatedKeys: translations }, null, 2),
                    },
                ],
            };
        }
