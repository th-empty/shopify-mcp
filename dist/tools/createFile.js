...
const FileCreateInputTypeSchema = z.object({
    originalSource: z
        .string()
        .describe("An external URL (for images) or a staged upload URL. e.g. https://example.com/image.jpg"),
...
export const createFile = {
    name: "create-file",
    description: "Creates files using external URLs (e.g. standard images). For non-image files, you need a Staged Upload URL first, which is not fully covered by this simple method.",
