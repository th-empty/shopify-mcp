...
const AdjustInventoryQuantitiesInputSchema = z.object({
    reason: z
        .string()
        .describe("Reason for the quantity adjustment (e.g. 'correction', 'received', 'reservation_created')"),
    name: z
...
const adjustInventoryQuantities = {
    ...
    description: "Adjust (increment or decrement) inventory quantities for items at specific locations.",
    ...
    execute: async (args) => {
      ...
      `;
            ...
            const { userErrors, inventoryAdjustmentGroup } = response.inventoryAdjustQuantities;
