...
export const updateMetaobjectDefinition = {
    ...
    description: "Updates a metaobject definition's configuration and field structure",
    ...
    execute: async (input) => {
      ...
      `;
            ...
            return {
                success: true,
                metaobjectDefinition: response.metaobjectDefinitionUpdate?.metaobjectDefinition,
            };
        }
        catch (error) {
